...
import { Context } from "../../../Context/Context";
 ...
 const  PAXCheckout=(props)=>{
    ...
    const [fullPayment,setFullPayment]=useState();
      ...
      //   try{
      //     const roomStatusDownload=await axios.post(`http://103.235.106.156:5000/server/hoteladmin/roomStatusPdf/${hotelId}`)
      ...
      //     }
      //     const result=await axios.post(`http://103.235.106.156:5000/server/hoteladmin/GetActiveCheckInByMobileNo/${hotelId}`,newData);
